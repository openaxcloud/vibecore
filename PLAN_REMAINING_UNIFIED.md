...
| V4-P1. Collecteur voyant : routes produit rendues JS + canal lancement ; retrouve Community Profiles | ✅ | ✅ `b42459fc` | ✅ 16/07 | collect-baseline v2, **7 familles** (docs/launch-channel/product-route/status/trust-safety/security/legal — `families` calculé depuis SOURCES, jamais dérivant) ; watchHits["Community Profiles"]==["community"] ; 🟡 rendu JS en CI = UNK-COLLECTOR-CI-RENDER |
