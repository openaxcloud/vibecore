...
| D3.3 Test de perte de zone (cordon zone-a → projet Python neuf en zone-b → uv/python → Preview → Publish → restore sans split-brain) | ✅ 17/07 | — | ⬜ | OBLIGATOIRE avant Python-par-défaut ; l'allowlist Nix reste à 3 projets, passage à `'*'` INTERDIT d'ici là |
