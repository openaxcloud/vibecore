...
export const chatBoxChildrenEn = {
  ...
  'chatBoxChildren.speech.startTitle': 'Dictate a message',
  'chatBoxChildren.speech.stopTitle': 'Stop dictation',
  'chatBoxChildren.speech.startLabel': 'Dictate',
  'chatBoxChildren.speech.stopLabel': 'Stop dictation',
  'chatBoxChildren.speech.requesting': 'Waiting for microphone access…',
  'chatBoxChildren.speech.listening': 'Listening…',
...
export const chatBoxChildrenFr: ChatBoxChildrenCopy = {
  ...
  'chatBoxChildren.speech.startTitle': 'Dicter un message',
  'chatBoxChildren.speech.stopTitle': 'Arrêter la dictée',
  'chatBoxChildren.speech.startLabel': 'Dicter',
  'chatBoxChildren.speech.stopLabel': 'Arrêter la dictée',
  'chatBoxChildren.speech.requesting': 'Autorisation du micro…',
  'chatBoxChildren.speech.listening': 'Écoute en cours…',
