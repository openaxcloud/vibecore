...
export const databaseStudioEn = {
  ...
  'databaseStudio.page': '{limit} / {offset}',
  'databaseStudio.pagePrevious': 'Previous rows',
  'databaseStudio.pageNext': 'Next rows',
  'databaseStudio.pageEmpty': 'No rows — limit {limit} offset {offset}',
  'databaseWorkbench.note.title': 'Not sure where your data went?',
  'databaseWorkbench.note.body':
    'Your project has two separate databases. What you add while building goes to the development database; your live app reads and writes the production one. A row saved on one side never appears on the other.',
  'databaseWorkbench.note.learnMore': 'Learn more',
  'databaseWorkbench.note.gotIt': 'Got it',
  'databaseWorkbench.note.dismissAria': 'Dismiss this note',
...
export const databaseStudioFr: DatabaseStudioCopy = {
  ...
  'databaseStudio.production': 'Production',
  'databaseStudio.page': '{limit} / {offset}',
  'databaseStudio.pagePrevious': 'Lignes précédentes',
  'databaseStudio.pageNext': 'Lignes suivantes',
  'databaseStudio.pageEmpty': 'Aucune ligne — limite {limit}, décalage {offset}',
  'databaseWorkbench.note.title': 'Vous ne retrouvez pas vos données ?',
  'databaseWorkbench.note.body':
    'Votre projet a deux bases séparées. Ce que vous ajoutez pendant que vous construisez va dans la base de développement ; votre application en ligne, elle, lit et écrit celle de production. Une ligne enregistrée d’un côté n’apparaît jamais de l’autre.',
  'databaseWorkbench.note.learnMore': 'En savoir plus',
  'databaseWorkbench.note.gotIt': 'J’ai compris',
  'databaseWorkbench.note.dismissAria': 'Masquer cette note',
