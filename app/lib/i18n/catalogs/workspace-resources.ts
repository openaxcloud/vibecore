...
export const workspaceResourcesFr: WorkspaceResourcesCopy = {
  ...
  'workspaceResources.loading': 'Lecture des ressources de l’espace de travail…',
  'workspaceResources.unavailable': 'Les ressources de cet espace de travail ne sont pas disponibles pour le moment.',
