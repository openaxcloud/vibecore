...
export const apiChatCatalog = {
  en: {
    ...
    websiteRead: 'Read {host}: {pages} page(s), {stylesheets} stylesheet(s)',
    websiteUnreachable: 'Could not read {host}: {reason}',
    webReasonRateLimited: 'too many site reads in the last 10 minutes',
    webReasonDigestFailed: 'the page could not be analysed',
    webReasonTimeBudget: 'the 20-second reading budget was spent',
    webReasonRobots: 'the site’s robots.txt forbids it',
    webReasonUnknown: 'unknown error ({code})',
  ...
  fr: {
    ...
    websiteUnreachable: '{host} inaccessible : {reason}',
    webReasonRateLimited: 'trop de lectures de sites ces 10 dernières minutes',
    webReasonDigestFailed: 'la page n’a pas pu être analysée',
    webReasonTimeBudget: 'le budget de lecture de 20 secondes est épuisé',
    webReasonRobots: 'le robots.txt du site l’interdit',
    webReasonUnknown: 'erreur inconnue ({code})',
