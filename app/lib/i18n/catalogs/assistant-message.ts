...
export const assistantMessageEn = {
  ...
  'assistantMessage.role.database': 'Database',
  'assistantMessage.role.security': 'Security',
  'assistantMessage.role.devops': 'DevOps',
  'assistantMessage.role.performance': 'Performance',
  'assistantMessage.role.accessibility': 'Accessibility',
  'assistantMessage.role.qa': 'QA',
  'assistantMessage.role.reviewer': 'Reviewer',
...
export const assistantMessageFr: AssistantMessageCopy = {
  ...
  'assistantMessage.role.database': 'Base de données',
  'assistantMessage.role.security': 'Sécurité',
  'assistantMessage.role.devops': 'DevOps',
  'assistantMessage.role.performance': 'Performance',
  'assistantMessage.role.accessibility': 'Accessibilité',
  'assistantMessage.role.qa': 'QA',
  'assistantMessage.role.reviewer': 'Révision',
