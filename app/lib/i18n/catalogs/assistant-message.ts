...
export const assistantMessageEn = {
  ...
  'assistantMessage.lanes.shortfallTitle': 'Incomplete delivery',
  'assistantMessage.lanes.shortfallRole': '{{role}} — {{written}} of {{announced}} files written',
  'assistantMessage.lanes.shortfallMissing': 'Not written: {{files}}',
...
export const assistantMessageFr: AssistantMessageCopy = {
  ...
  'assistantMessage.lanes.shortfallTitle': 'Livraison incomplète',
  'assistantMessage.lanes.shortfallRole': '{{role}} — {{written}} fichiers écrits sur {{announced}}',
  'assistantMessage.lanes.shortfallMissing': 'Non écrits : {{files}}',
  'assistantMessage.lanes.consensusStatus': 'consensus : {{status}}',
