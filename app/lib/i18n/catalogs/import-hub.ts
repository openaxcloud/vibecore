...
export const importHubEn = {
  ...
  'importHub.preview.description':
    'Review the staged file list and secret scan before a project is created. File contents stay hidden here.',
  ...
  'importHub.preview.scanFound': '{{count}} secret-shaped finding(s) need an explicit decision.',
  ...
  'importHub.preview.error.unresolved': 'Every finding needs an explicit decision before commit.',
  'importHub.preview.error.stagingGone': 'This staged copy is no longer available. Start a new import.',
  'importHub.preview.error.commitFailed': 'The import could not be committed. No success was reported.',
  'importHub.preview.error.cancelFailed': 'Cancellation could not be confirmed. The staged import is still available.',
  'importHub.preview.redactedNote': 'Redaction rewrites only the staged copy; your source is never modified.',
...
export const importHubFr: ImportHubCopy = {
  ...
  'importHub.preview.description':
    'Vérifiez la liste préparée et l’analyse des secrets avant toute création de projet. Le contenu reste masqué ici.',
  'importHub.preview.source': 'Source',
  ...
  'importHub.preview.scanFound': '{{count}} détection(s) de forme secrète exigent une décision explicite.',
  ...
  'importHub.preview.error.unresolved': 'Chaque détection exige une décision explicite avant le commit.',
  'importHub.preview.error.stagingGone': 'Cette copie préparée n’est plus disponible. Relancez un import.',
  'importHub.preview.error.commitFailed': 'L’import n’a pas pu être commité. Aucun succès n’a été annoncé.',
  'importHub.preview.error.cancelFailed': 'L’annulation n’a pas pu être confirmée. L’import préparé reste disponible.',
  'importHub.preview.redactedNote': 'Le masquage modifie uniquement la copie préparée, jamais votre source.',
