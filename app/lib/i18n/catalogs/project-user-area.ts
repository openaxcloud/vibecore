    ...
    deployments: {
      ...
      publish: {
        ...
        entitlements: {
          ...
          description: 'Verified server-side for this project and provider before a release can be created.',
          loading: 'Verifying publication permissions',
          errorTitle: 'Publication permissions could not load',
          errorDescription: 'Your plan permissions could not be verified. No deployment can be created yet.',
          retry: 'Retry permission check',
          unavailableTitle: 'This provider is not ready for publication',
          providerEdgeRequired:
            'This provider cannot enforce the publication badge and traffic policy. Choose Static or Server.',
          regionOperatorRequired:
            'No publication region has been provisioned for this provider. Ask your Enterprise operator to configure one.',
          invalidPolicy: 'The returned publication policy is incomplete. Retry before publishing.',
          provider: 'Verified provider',
          region: 'Default region',
          regionLabel: 'Publication region',
          regionAutomatic:
            'The only verified region is selected automatically and is not submitted as a user override.',
          removeBadge: 'Remove the E-Code badge',
          removeBadgeDescription: 'Your plan permits this release to omit the E-Code publication badge.',
          badgeRequired: 'E-Code badge required',
          badgeRequiredDescription: 'This plan requires the server-enforced E-Code badge on the published release.',
          ...
          rateCardLoading: 'Loading the server rate card',
          rateCardErrorTitle: 'Server sizes could not load',
          rateCardErrorDescription: 'A server deployment cannot start until its current rate card is verified.',
          rateCardRetry: 'Reload server sizes',
        },
    ...
    deployments: {
      ...
      publish: {
        ...
        entitlements: {
          ...
          description: 'Vérifiée côté serveur pour ce projet et ce fournisseur avant la création de toute version.',
          loading: 'Vérification des autorisations de publication',
          errorTitle: 'Impossible de charger les autorisations de publication',
          errorDescription:
            'Les autorisations de votre offre n’ont pas pu être vérifiées. Aucun déploiement ne peut encore être créé.',
          retry: 'Relancer la vérification',
          unavailableTitle: 'Ce fournisseur n’est pas prêt pour la publication',
          providerEdgeRequired:
            'Ce fournisseur ne peut pas appliquer la politique de badge et de mesure du trafic. Choisissez Statique ou Serveur.',
          regionOperatorRequired:
            'Aucune région de publication n’a été provisionnée pour ce fournisseur. Demandez à votre opérateur Enterprise d’en configurer une.',
          invalidPolicy: 'La politique de publication reçue est incomplète. Réessayez avant de publier.',
          provider: 'Fournisseur vérifié',
          region: 'Région par défaut',
          regionLabel: 'Région de publication',
          regionAutomatic:
            'La seule région vérifiée est sélectionnée automatiquement et n’est pas transmise comme choix utilisateur.',
          removeBadge: 'Retirer le badge E-Code',
          removeBadgeDescription:
            'Votre offre permet à cette version de ne pas afficher le badge de publication E-Code.',
          badgeRequired: 'Badge E-Code obligatoire',
          badgeRequiredDescription: 'Cette offre impose le badge E-Code appliqué côté serveur sur la version publiée.',
          version: 'politique {version}',
          providers: {
            static: 'Edge statique',
            server: 'Serveur géré',
          },
          plans: {
            starter: 'Starter',
          ...
          rateCardLoading: 'Chargement de la grille tarifaire serveur',
          rateCardErrorTitle: 'Impossible de charger les tailles de serveur',
          rateCardErrorDescription:
            'Un déploiement serveur ne peut pas démarrer tant que sa grille tarifaire actuelle n’est pas vérifiée.',
          rateCardRetry: 'Recharger les tailles de serveur',
        },
