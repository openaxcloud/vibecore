...
export const chatControlsEn = {
  ...
  'chatControls.sheet.modesTitle': 'Agent modes',
  'chatControls.sheet.auto': 'Auto',
  'chatControls.sheet.primaryModel': 'Primary model — {mode}',
  'chatControls.sheet.primaryModelHint': 'Auto · default',
  'chatControls.sheet.advanced': 'Advanced settings',
  'chatControls.sheet.advancedHint': 'Effort, redundancy and billing options.',
  'chatControls.sheet.lockedFromPower': 'Available from Power upward.',
  'chatControls.sheet.chooseForMe': 'Choose automatically',
  'chatControls.sheet.recommended': 'recommended',
  'chatControls.sheet.chooseForMeHint': 'We pick the least expensive model in this mode.',
  'chatControls.sheet.effort': 'Effort',
  'chatControls.sheet.fastSuffix': ' · fast',
  'chatControls.sheet.effortLow': 'Low',
  'chatControls.sheet.effortMax': 'Max',
  'chatControls.sheet.effortSuggested': 'Suggested for {model}: {level}',
  'chatControls.sheet.effortUnsupported': 'This model has no effort setting.',
  'chatControls.sheet.effortRecommended': 'recommended for this model',
  'chatControls.sheet.unavailable': 'Temporarily unavailable',
  'chatControls.sheet.unavailableCredit': 'The provider account needs topping up.',
  'chatControls.sheet.unavailableReach': 'The provider is not responding right now.',
  'chatControls.sheet.notConfigured': 'No key configured for this provider.',
  'chatControls.sheet.fallbackNotice': '{asked} is unavailable — {served} is answering instead.',
  'chatControls.sheet.effort1': 'Answers as fast as possible, with little exploration.',
  'chatControls.sheet.effort2': 'Checks the essentials before answering.',
  'chatControls.sheet.effort3': 'Balances thinking and speed.',
  'chatControls.sheet.effort4': 'Takes time to check its own work.',
  'chatControls.sheet.effort5': 'Explores thoroughly. Slower and costlier.',
  ...
  'chatControls.power.tier.powerHint': 'The right balance.',
  'chatControls.power.tier.max': 'Max',
  'chatControls.power.tier.maxHint': 'For complex tasks.',
  'chatControls.power.liteGuardrail':
    'Lite suits focused changes to an existing app. For a new app, major architecture change, integration, or database schema change, choose Power or Max.',
...
export const chatControlsFr: ChatControlsCopy = {
  ...
  'chatControls.sheet.modesTitle': 'Modes de l’agent',
  'chatControls.sheet.auto': 'Auto',
  'chatControls.sheet.primaryModel': 'Modèle principal — {mode}',
  'chatControls.sheet.primaryModelHint': 'Auto · réglage d’origine',
  'chatControls.sheet.advanced': 'Réglages avancés',
  'chatControls.sheet.advancedHint': 'Effort, redondance et options de facturation.',
  'chatControls.sheet.lockedFromPower': 'Disponible à partir du mode Power.',
  'chatControls.sheet.chooseForMe': 'Choisir automatiquement',
  'chatControls.sheet.recommended': 'conseillé',
  'chatControls.sheet.chooseForMeHint': 'Nous retenons le modèle le moins cher de ce mode.',
  'chatControls.sheet.effort': 'Effort',
  'chatControls.sheet.fastSuffix': ' · rapide',
  'chatControls.sheet.effortLow': 'Minimal',
  'chatControls.sheet.effortMax': 'Maximal',
  'chatControls.sheet.effortSuggested': 'Conseillé pour {model} : {level}',
  'chatControls.sheet.effortUnsupported': 'Ce modèle n’a pas de réglage d’effort.',
  'chatControls.sheet.effortRecommended': 'recommandé pour ce modèle',
  'chatControls.sheet.unavailable': 'Momentanément indisponible',
  'chatControls.sheet.unavailableCredit': 'Le compte du fournisseur doit être rechargé.',
  'chatControls.sheet.unavailableReach': 'Le fournisseur ne répond pas en ce moment.',
  'chatControls.sheet.notConfigured': 'Aucune clé configurée pour ce fournisseur.',
  'chatControls.sheet.fallbackNotice': '{asked} est indisponible — c’est {served} qui répond.',
  'chatControls.sheet.effort1': 'Répond au plus vite, sans explorer.',
  'chatControls.sheet.effort2': 'Vérifie l’essentiel avant de répondre.',
  'chatControls.sheet.effort3': 'Équilibre réflexion et rapidité.',
  'chatControls.sheet.effort4': 'Prend le temps de vérifier son travail.',
  'chatControls.sheet.effort5': 'Explore à fond. Plus lent, plus coûteux.',
  'chatControls.power.tier.lite': 'Lite',
  'chatControls.power.tier.liteHint':
    'Rapide et économique. Ajustements visuels, corrections de bugs et modifications ciblées.',
  'chatControls.power.tier.power': 'Power',
  'chatControls.power.tier.powerHint': 'Le juste équilibre.',
  'chatControls.power.tier.max': 'Max',
  'chatControls.power.tier.maxHint': 'Pour les tâches complexes.',
  'chatControls.power.liteGuardrail':
