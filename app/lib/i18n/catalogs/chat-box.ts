...
export const chatBoxEn = {
  ...
  'chatBox.speech.stop': 'Stop dictation',
  'chatBox.speech.start': 'Dictate',
  'chatBox.speech.requestingPlaceholder': 'Allow microphone access to dictate…',
  'chatBox.speech.listeningPlaceholder': 'Listening… speak, then tap the microphone to stop.',
...
export const chatBoxFr: ChatBoxCopy = {
  ...
  'chatBox.speech.stop': 'Arrêter la dictée',
  'chatBox.speech.start': 'Dicter',
  'chatBox.speech.requestingPlaceholder': 'Autorisez l’accès au micro pour dicter…',
  'chatBox.speech.listeningPlaceholder': 'Je vous écoute… Parlez, puis appuyez sur le micro pour arrêter.',
