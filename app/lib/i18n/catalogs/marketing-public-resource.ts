...
export const marketingPublicResourceFr = {
  templates: {
    ...
    searchPlaceholder: 'Rechercher un modèle, une stack ou un tag…',
    clearSearch: 'Effacer la recherche',
    tagFilterLabel: 'Filtrer les modèles par tag',
    all: 'Tous',
    noQueryMatchPrefix: 'Aucun modèle ne correspond à « ',
    noQueryMatchSuffix: ' »',
    noTagMatch: 'Aucun modèle ne correspond à ce tag',
    noMatchDescription:
      'Essayez une autre recherche ou un autre tag, ou effacez les filtres pour parcourir tout le catalogue.',
  ...
  community: {
    ...
    pillars: [
      ...
      },
      {
        id: 'challenges',
        title: 'Défis',
        body: 'Participez à des créations guidées pour les agents, applications mobiles, tableaux de bord et backends de production.',
      },
    ],
    feed: {
    ...
    searchPlaceholder: 'Rechercher une discussion, un tag ou un profil…',
