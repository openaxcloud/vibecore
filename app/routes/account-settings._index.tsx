...
function profileFields(copy: AccountProfileCopy) {
  return [
    { label: copy.fields.name, name: 'name', type: 'text', placeholder: copy.fields.namePlaceholder },
    { label: copy.fields.email, name: 'email', type: 'email', placeholder: copy.fields.emailPlaceholder },
  ] as const;
}
