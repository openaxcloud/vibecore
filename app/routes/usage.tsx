                    ...
                    {tone !== 'ok' ? (
                      <div className="mt-2 flex flex-wrap items-center justify-between gap-2 text-xs">
                        ...
                        {tone === 'error' ? (
                          <Link
                            to="/upgrade"
                            className="inline-flex min-h-[44px] items-center justify-center rounded-md bg-[var(--vc-cta-accent,var(--vc-ide-accent-action))] px-3 text-xs font-medium text-[var(--vc-cta-accent-ink,var(--vc-ide-on-accent-action))] transition-opacity hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--vc-ide-accent-action)]"
                          >
