...
const ACTION_CTA_CLASS =
  'inline-flex min-h-9 w-full items-center justify-center whitespace-normal rounded-md bg-[var(--vc-ide-accent-action)] px-4 py-2 text-center text-sm font-medium text-[var(--vc-ide-on-accent-action)] transition-opacity hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--vc-ide-accent-action)] disabled:cursor-not-allowed disabled:opacity-60';
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  {isCurrent ? (
                    ...
                    <span className="rounded-full bg-[var(--vc-ide-accent-action)] px-2 py-0.5 text-xs font-medium text-[var(--vc-ide-on-accent-action)]">
