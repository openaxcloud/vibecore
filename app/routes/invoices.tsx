                ...
                <span className="flex shrink-0 flex-wrap items-center gap-2">
                  {unpaid && invoice.hostedInvoiceUrl ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex min-h-[44px] items-center rounded-md bg-[var(--vc-ide-accent-action)] px-3 text-sm font-medium text-[var(--vc-ide-on-accent-action)] transition-opacity hover:opacity-90"
                    >
