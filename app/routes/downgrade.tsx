      ...
      <Form method="post" reloadDocument className="space-y-5">
        ...
        {data.hasActiveSubscription || toFree ? (
          <button
            ...
            value="portal"
            disabled={submitting}
            className="inline-flex min-h-[44px] items-center justify-center rounded-md bg-[var(--vc-action-primary)] px-4 text-sm font-medium text-[var(--vc-action-primary-foreground)] transition-opacity hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--vc-ide-accent-action)] disabled:cursor-not-allowed disabled:opacity-60"
          >
