      ...
      <div className="grid gap-6">
        {['PAST_DUE', 'UNPAID', 'past_due', 'unpaid'].includes(billing.subscription?.status ?? '') ? (
          ...
          >
            ...
            <Link
              to="/payment-method"
              className="inline-flex min-h-[44px] shrink-0 items-center justify-center rounded-md bg-[var(--vc-cta-accent,var(--vc-ide-accent-action))] px-3 text-xs font-medium text-[var(--vc-cta-accent-ink,var(--vc-ide-on-accent-action))] transition-opacity hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--vc-ide-accent-action)]"
            >
