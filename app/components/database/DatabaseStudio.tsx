          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md bg-[var(--vc-ide-accent-action)] px-3 py-1.5 text-[13px] font-medium text-[var(--vc-ide-text-on-accent)] hover:opacity-90 disabled:opacity-60"
              >
