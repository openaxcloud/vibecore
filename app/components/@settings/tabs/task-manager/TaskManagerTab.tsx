    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-3 rounded-lg border border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 p-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="min-h-11 rounded-lg bg-[var(--vc-ide-accent-action)] px-4 py-2 text-sm font-medium whitespace-normal text-[var(--vc-ide-text-on-accent)] transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--vc-ide-focus-ring)] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
