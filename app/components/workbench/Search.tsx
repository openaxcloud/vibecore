        ...
        {pendingUnsavedPaths.length > 0 && (
          ...
          >
            ...
            <button
              ...
              className="mt-2 inline-flex min-h-9 items-center whitespace-normal rounded-md bg-[var(--vc-action-primary)] px-2.5 py-1 text-left text-xs font-medium text-[var(--vc-action-primary-foreground)] transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
            >
