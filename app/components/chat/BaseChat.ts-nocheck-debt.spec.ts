 ...
 *
 * Les trois plantages sont corrigés. Il reste 12 erreurs de typage, aucune de
 * type « nom introuvable ». Ce test les fige : la dette peut DIMINUER, jamais
 * augmenter.
 *
...
describe('TSNOCHECK-DEBT-001 — les plantages masqués sont corrigés', () => {
  ...
  it('garde la directive ACCOMPAGNÉE de sa dette chiffrée', () => {
    /*
     * On ne retire pas la directive dans cette livraison : 12 erreurs de typage
    ...
    expect(header).toMatch(/12 erreurs/);
