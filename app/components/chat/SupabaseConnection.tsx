          ...
          <Dialog className="max-w-[520px] p-6">
            {!isConnected ? (
                ...
                <div>
                  ...
                  <input
                    ...
                    className={classNames(
                      ...
                      'bg-[#F8F8F8] dark:bg-bolt-elements-bg-depth-3',
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-3 bg-[#F8F8F8] dark:bg-bolt-elements-bg-depth-3 rounded-lg">
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-2 py-1 rounded-md text-xs bg-[#F0F0F0] dark:bg-bolt-elements-bg-depth-3 text-bolt-elements-textSecondary hover:bg-[#E5E5E5] dark:hover:bg-bolt-elements-bg-depth-4 flex items-center gap-1"
                    ...
                    {isProjectsExpanded && (
                      <>
                        {!supabaseConn.selectedProjectId && (
                          <div className="mb-2 p-3 bg-[#F8F8F8] dark:bg-bolt-elements-bg-depth-3 rounded-lg text-sm text-bolt-elements-textSecondary">
                                  ...
                                  <button
                                    ...
                                    className={classNames(
                                      ...
                                      supabaseConn.selectedProjectId === project.id
                                        ? 'bg-[#3ECF8E] text-white'
                                        : 'bg-[#F0F0F0] dark:bg-bolt-elements-bg-depth-3 text-bolt-elements-textSecondary hover:bg-[#3ECF8E] hover:text-white',
                                    )}
                                  >
                                    {supabaseConn.selectedProjectId === project.id ? (
