...
const GRADIENT_COLORS = [
  'from-[color-mix(in_srgb,var(--vc-ide-accent-action)_10%,transparent)] to-blue-500/5',
  ...
  'from-pink-500/10 to-[color-mix(in_srgb,var(--vc-ide-accent-action)_5%,transparent)]',
];
  ...
  return (
    <motion.div
      className={classNames(
        ...
        gradientClass,
        borderEffect
          ? 'border border-bolt-elements-borderColor hover:border-[color-mix(in_srgb,var(--vc-ide-accent-action)_40%,transparent)]'
          : '',
