    ...
    return (
      <div className="bolt-publication" data-testid="publication">
        <header className="bolt-publication-entete">
          ...
          <button type="button" className="bolt-publication-reglages" onClick={onAjusterLesReglages}>
        ...
        >
          {dernier ? (
            <p className="bolt-publication-quand">
              {texte(dernier.status === 'FAILED' ? copy['publication.failedAgo'] : copy['publication.publishedAgo'], {
