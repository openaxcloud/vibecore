...
export default function Terms() {
  ...
  const copy = catalog.exactTerms;
  const lastUpdated = formatLegalMonthYear(LEGAL_DATES.terms, language);
      ...
      <main className="flex-1">
        <div className="container-responsive py-responsive">
          <article className="mx-auto min-w-0 max-w-4xl">
            <h1 className="mb-8 break-words text-responsive-2xl font-bold" data-testid="heading-terms">
              {copy.title}
            </h1>
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none space-y-8 break-words [overflow-wrap:anywhere]">
              ...
              <section aria-labelledby="terms-contact">
                <h2 id="terms-contact" className="mt-8 mb-4 text-2xl font-semibold">
                  {copy.contact.title}
                </h2>
