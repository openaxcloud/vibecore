...
const productItems: MenuItem[] = [
  ...
  {
    title: 'Import Hub',
    href: '/dashboard/templates?section=import',
    description: 'Validate one of 12 supported sources before creating an isolated project.',
  },
  {
    title: 'Deployments',
...
const resourcesItems: MenuItem[] = [
  ...
  { title: 'Community', href: '/community', description: 'Connect with builders and share best practices.' },
  {
    ...
    href: '/templates',
    description: 'Preview published applications and remix an isolated copy.',
  },
  {
    title: 'Marketplace',
    href: '/marketplace',
    description: 'Discover extensions, integrations and reusable product capabilities.',
  },
...
const footerLinks = {
  product: [
    ...
    { label: 'Import Hub', href: '/dashboard/templates?section=import' },
  ...
  resources: [
    ...
    { label: 'Community Gallery', href: '/templates' },
