...
export const ecodePricingPlans = [
  {
    key: 'free',
    name: 'Free',
    description: 'Perfect for trying E-Code and building your first projects',
    monthlyCents: 0,
  ...
  },
  {
    key: 'pro',
    name: 'Pro',
    description: 'For builders shipping private projects with AI agents',
    monthlyCents: 2900,
    annualMonthlyCents: 2300,
    cta: 'Start Pro',
    popular: true,
    enterprise: false,
