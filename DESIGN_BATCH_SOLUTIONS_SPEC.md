...
- Illustrations/captures E-Code uniquement ; aucune banque d'images. Toute image sous la ligne de flottaison porte `loading="lazy"`, `width`, `height` et un texte alternatif réel.
