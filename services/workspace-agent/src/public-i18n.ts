...
const copy = {
  en: {
    ...
    fileContentChanged: 'The file changed before this save could be applied.',
  ...
  fr: {
    ...
    fileContentChanged: 'Le fichier a changé avant que cet enregistrement puisse être appliqué.',
