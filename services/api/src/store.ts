...
import type { AccountPurgeDeps, PurgeUserAccountResult } from './account-purge.js';
...
export interface ApiStore {
   ...
   */
  purgeUserAccount(input: { userId: string; nowMs?: number }, deps?: AccountPurgeDeps): Promise<PurgeUserAccountResult>;
