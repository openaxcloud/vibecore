...
| 3 | Official checks green, by workflow **ID** | `required-checks.json` pins **id + file path + job names** | 78 vitest cases; pinning by name alone cannot pass |
...
# 5. Full suite
pnpm vitest --run scripts/release-gate      # 78 tests
```
