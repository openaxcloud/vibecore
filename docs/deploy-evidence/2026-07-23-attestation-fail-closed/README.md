...
|---|---|---|
| `01-substitution-test.log` | tests négatifs par champ, dont §3c suppression | 0 |
| `02-repro-fail-closed.log` | repro bout-en-bout : pur + structurel rejettent chaque amputation | 0 |
| `03-validate-registries-clean.log` | validateur complet sur arbre propre → « all registries valid » | 0 |
