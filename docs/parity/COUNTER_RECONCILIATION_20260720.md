...
| P0 OPEN | **24** | count(status=OPEN) | P0-V3-01, P0-V3-04, P0-V3-05, P0-V3-06, P0-V3-07, P0-V3-08, P0-V3-09, P0-V3-10, P0-V3-11, P0-V3-12, P0-V3-13, P0-A2-01, P0-A2-03, P0-A2-07, P0-A2-09, P0-A2-13, P0-LS-06, P0-B-01, P0-B-02, P0-EX-04, P0-EX-05, P0-EX-07, P0-EX-08, P0-EX-10 | P0_REGISTRY.yaml |
| P0 PROVEN_REVIEW_PENDING | **34** | count(status=PROVEN_REVIEW_PENDING) | P0-V4-1, P0-V4-2, P0-V4-3, P0-V3-02, P0-V3-03, P0-V3-14, P0-A2-02, P0-A2-04, P0-A2-05, P0-A2-06, P0-A2-08, P0-A2-11, P0-A2-14, P0-LS-01, P0-LS-02, P0-LS-03, P0-LS-05, P0-LS-07, P0-LS-08, P0-LS-09, P0-LS-10, P0-LS-11, P0-LS-12, P0-LS-13, P0-LS-14, P0-LS-15, P0-LS-16, P0-LS-17, P0-LS-18, P0-EX-01, P0-EX-02, P0-EX-03, P0-EX-06, P0-EX-09 | P0_REGISTRY.yaml |
...
| Lot A (corrections rapides) | **14** | count(remediationTrack=QUICK) | P0-V4-1, P0-V4-2, P0-V4-3, P0-V3-02, P0-V3-03, P0-A2-05, P0-A2-10, P0-A2-14, P0-LS-03, P0-LS-04, P0-LS-13, P0-LS-14, P0-LS-16, P0-EX-02 | P0_REGISTRY.yaml |
| Lot B (chantiers P0) | **4** | count(remediationTrack=CHANTIER) | P0-V3-12, P0-A2-09, P0-EX-04, P0-EX-10 | P0_REGISTRY.yaml |
| Refus à trier (raisons reçues 20/07 soir) | **15** | count(remediationTrack=A_TRIER) | P0-V3-04, P0-V3-08, P0-V3-09, P0-V3-10, P0-V3-11, P0-V3-13, P0-A2-01, P0-A2-03, P0-A2-07, P0-A2-13, P0-LS-06, P0-B-01, P0-EX-05, P0-EX-07, P0-EX-08 | P0_REGISTRY.yaml |
...
1. **Refus → ouverts** : **31** P0 portent actuellement `reviewVerdict: REFUSED`.
   **24** P0 sont déclarés OPEN, dont **19** refusés
...
2. **Le 8e point rapide** : le tableau transmis à Avi n'en montrait que 7 et INCLUAIT
   ...
   `remediationTrack: QUICK` : P0-V4-1, P0-V4-2, P0-V4-3, P0-V3-02, P0-V3-03, P0-A2-05, P0-A2-10, P0-A2-14, P0-LS-03, P0-LS-04, P0-LS-13, P0-LS-14, P0-LS-16, P0-EX-02. **LS-04 et LS-16 en font partie** ;
