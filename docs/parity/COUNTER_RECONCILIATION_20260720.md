...
| Contrats refusés | **5** | count(fichiers docs/parity avec reviewVerdict: REFUSED) | CHECKPOINT_CONTRACT.md, IDENTITY_COLLABORATION_CONTRACT.md, OPERATIONS_DR.md, PROJECT_FACTORY_CONTRACT.md, PROJECT_MANIFEST_SCHEMA.json | annotations des fichiers de contrat |
...
4. **Comptage des 14 contrats** : DEUX vues cohérentes — (a) **14 points individuels**
   = les fichiers annotés `reviewVerdict: REFUSED` (comptés ci-dessus : 5),
