...
| Lot A (corrections rapides) | **11** | count(remediationTrack=QUICK) | P0-V4-1, P0-V4-2, P0-V4-3, P0-V3-02, P0-V3-03, P0-A2-10, P0-LS-03, P0-LS-04, P0-LS-13, P0-LS-14, P0-LS-16 | P0_REGISTRY.yaml |
| Lot B (chantiers P0) | **5** | count(remediationTrack=CHANTIER) | P0-V3-12, P0-A2-09, P0-EX-02, P0-EX-04, P0-EX-10 | P0_REGISTRY.yaml |
| Refus à trier (raisons reçues 20/07 soir) | **17** | count(remediationTrack=A_TRIER) | P0-V3-04, P0-V3-08, P0-V3-09, P0-V3-10, P0-V3-11, P0-V3-13, P0-A2-01, P0-A2-03, P0-A2-05, P0-A2-07, P0-A2-13, P0-A2-14, P0-LS-06, P0-B-01, P0-EX-05, P0-EX-07, P0-EX-08 | P0_REGISTRY.yaml |
...
2. **Le 8e point rapide** : le tableau transmis à Avi n'en montrait que 7 et INCLUAIT
   À TORT P0-EX-10 (qui est un chantier B). Le lot A machine-tracé = les 11 IDs
   `remediationTrack: QUICK` : P0-V4-1, P0-V4-2, P0-V4-3, P0-V3-02, P0-V3-03, P0-A2-10, P0-LS-03, P0-LS-04, P0-LS-13, P0-LS-14, P0-LS-16. **LS-04 et LS-16 en font partie** ;
