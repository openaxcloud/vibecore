...
| Contrats refusés | **11** | count(fichiers docs/parity avec reviewVerdict: REFUSED) | CHECKPOINT_CONTRACT.md, DEPLOYMENT_TYPES_CONTRACT.md, DOMAIN_MODEL.md, IAM_POLICY_BASELINE.md, IDENTITY_COLLABORATION_CONTRACT.md, OPERATIONS_DR.md, PROJECT_FACTORY_CONTRACT.md, PROJECT_MANIFEST_SCHEMA.json, RELEASE_PUBLISH_CONTRACT.md, RUNTIME_NIX_CONTRACT.md, SECURITY_PRIVACY_COMPLIANCE.md | annotations des fichiers de contrat |
