...
| Traçage audit de couverture (P1-COV ×8, BD ×26, PR ×48, 6 surfaces, DEC/UNK billing legacy, ACTIONS_AVI, garde CI EXPECTED_*_IDS) | ✅ | ✅ cette PR | ⬜ | `docs/parity/COVERAGE_GAP_AUDIT_2026-07-17.md` + `BOLT_DEBT_REGISTRY.yaml` + `PRODUCTION_READINESS_REGISTRY.yaml` — ✅ après merge + CI parity-registries verte sur main ; contenu 100 % NON_FAIT/OPEN (traçage, pas réalisation) |
