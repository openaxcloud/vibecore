...
| implementationReady | ❌ FAIL (P0-V3-01 is OPEN … +14) |
...
**Compteurs (source unique)** : P0 65 (15 OPEN · 5 PROVEN · 2 CLOSED) · P1 40 · surfaces déclarées 10 (univers 159/159 importé, 1 évaluées, 56 services) · e2e 12/12 · constats 336 → 122 work items · claims non ancrées 0 · uiGaps [publish, rollback]
