...
**Attestation CI** : run 29763506531 (2026-07-20T17:23:45Z, commit 9cdee152) — verte.
...
| publicLaunchReady | ❌ FAIL (betaReady not passed … +69) |
| parityBaselineReady | ❌ FAIL (surface SRF-IDE-FILE-HISTORY not done … +10) |

**Compteurs (source unique)** : P0 65 (30 OPEN · 5 PROVEN · 0 CLOSED) · P1 40 · surfaces déclarées 10 (univers 159/159 importé, 1 évaluées, 56 services) · e2e 12/12 · constats 336 → 122 work items · claims non ancrées 0 · uiGaps [publish, rollback]
