...
refusalReason: threat model/rétention incomplets (verbatim relecteur, transmis 20/07)
reviewCloseCriterion: corriger — threat model/rétention incomplets — puis re-soumettre à signature
