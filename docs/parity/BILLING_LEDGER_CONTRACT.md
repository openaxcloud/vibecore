...
signatureResult: PENDING_REVIEW   # v1 REFUSED (« shadow wallet ») ; v2 REFUSED (RR-20260721-CODEX-04 : 5 motifs) ; v3 = fix-forward PR #39 (96f53af7), les 4 défauts de code corrigés avec 4 preuves vrai Postgres B1-B4 — voir §7
