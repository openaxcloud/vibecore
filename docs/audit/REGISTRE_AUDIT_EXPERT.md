...
| `🟠 PARTIEL` (PR ouverte, reste identifié) | 2 | **AUDX-004** — PR #357 : usage unique non livré, exige un magasin `jti`. **AUDX-005** — PR #361 : code prêt, bascule d'exploitation non faite (D-02 encore non tenue). |
