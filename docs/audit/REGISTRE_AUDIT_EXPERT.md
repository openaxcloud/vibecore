...
| `✅ CORRIGÉ` (PR ouverte, non mergée) | 5 | **AUDX-003** — PR #354 ; **AUDX-001** — PR #355 ; **AUDX-008** — PR #363 ; **AUDX-018** — PR #368 ; **AUDX-006** — PR #362 (complétée). |
| `🟠 PARTIEL` (PR ouverte, reste identifié) | 3 | **AUDX-004** — PR #357 : usage unique non livré, exige un magasin `jti`. **AUDX-005** — PR #361 : code prêt, bascule d'exploitation non faite (D-02 encore non tenue). **AUDX-017** — PR #365 : provenance tracée, sous-déclaration visible mais pas impossible. |
