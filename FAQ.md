...
<details>
<summary><strong>What are the best models for E-Code?</strong></summary>

For the best experience with E-Code, we recommend using the following models:
...
**Note**: Models with less than 7b parameters typically lack the capability to properly interact with E-Code!

</details>

<details>
<summary><strong>How do I get the best results with E-Code?</strong></summary>

- **Be specific about your stack**:  
  Mention the frameworks or libraries you want to use (e.g., Astro, Tailwind, ShadCN) in your initial prompt. This ensures that E-Code scaffolds the project according to your preferences.
...
- **Scaffold the basics first, then add features**:  
  Ensure the foundational structure of your application is in place before introducing advanced functionality. This helps E-Code establish a solid base to build on.
...
<details>
<summary><strong>How do I contribute to E-Code?</strong></summary>
...
<details>
<summary><strong>How do local LLMs compare to larger models like Claude 3.5 Sonnet for E-Code?</strong></summary>
